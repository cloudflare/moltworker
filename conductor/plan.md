...
This file is the source of truth for the project's development plan.

Update protocol: sync this plan after closing any track or adding any new track.
...
- Stabilize MCP tooling and CLI workflows.
- Keep lint and typecheck clean while planning Zod v4 adoption.
...
- Zod v4 + MCP SDK Upgrade
  - Track plan: ./tracks/zod_v4_mcp_sdk_upgrade_20260210/plan.md
