/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 9e4c77f6c985bd84acff9fff9f932ca4)
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "ANTHROPIC_API_KEY" | "MOLTBOT_GATEWAY_TOKEN" | "AI_GATEWAY_TOKEN" | "TELEGRAM_BOT_TOKEN" | "WORKER_URL">> {}
}
declare module "*.html" {
	const value: string;
