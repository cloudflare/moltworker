...
- PR title: "feat: initialize project roadmap"
- PR body: include the full roadmap content as preview
...
- PR title: concise, under 70 chars, describes the task
- PR body: include summary of changes and what roadmap task was completed
