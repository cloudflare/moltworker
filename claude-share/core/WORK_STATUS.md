...
|----------|-------------|--------|---------|
| Claude | Phase 2.5.5 complete | `claude/review-moltworker-roadmap-q5aqD` | 2026-02-08 |
| Codex | — | — | — |
| Other | — | — | — |
...
|--------|-------------|----------------|-------|
| Sprint 1 (current) | 8 | 15 | Phase 0 complete, Phase 1.1+1.2 complete, upstream sync complete, Phase 2.5.1-2.5.3+2.5.5 complete, ahead of plan |
